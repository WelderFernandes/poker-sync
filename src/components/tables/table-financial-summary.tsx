...
export function TableFinancialSummary({
  buyInAmount,
  players,
  totalPot,
}: TableFinancialSummaryProps) {
  ...
  const percentCollected =
    potentialTotal > 0 ? (totalPot / potentialTotal) * 100 : 0
