...
interface WorstPlayersProps {
  players: PlayerStats[]
}

export function WorstPlayers({ players }: WorstPlayersProps) {
  if (players.length === 0) {
    return (
      <Card className="col-span-1">
        <CardHeader>
          <CardTitle>Jogadores com Dificuldades</CardTitle>
          <CardDescription>
            Jogadores com as menores taxas de vitória
          </CardDescription>
        </CardHeader>
        <CardContent>
